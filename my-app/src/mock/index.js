export const explicationCell = 'Introdução Certa vez, um garoto perguntou para um homem de Deus: – O que é unção? O homem de Deus, então, chamando a atenção do garoto para um boi que pastava à distância, indagou: – Você está vendo aquele boi pastando? – Sim. – Aquilo não é unção. Em seguida, olhou para um passarinho que cantava no galho de uma árvore, e disse: – Você está ouvindo aquele passarinho cantando? – Sim. – Aquilo também não é unção. O garoto, exasperado, insistiu com o ancião: – Diga-me, então, o que é unção? Após uma pausa breve, o homem voltou-se para o garoto e concluiu, dizendo: – Se você vir um boi no galho de uma árvore, cantando feito passarinho, aquilo, sim, é unção. A verdadeira realidade da Igreja é sobrenatural. Se tudo o que temos são passarinhos cantando nos telhados e bois pastando nos campos, então, não temos nada além do que o mundo tem. A verdadeira obra de Deus precisa ser sobrenatural, celestial e inusitada. Estamos falando isso a propósito deste manual sobre a nossa estrutura de células em nossa igreja local. O nosso crescimento não vem porque temos uma boa estrutura e uma boa organização. Se a nossa obra se resume a uma boa estrutura organizacional, então, o que temos que o mundo não tem? O mundo possui estratégias de marketing, qualidade total, gerenciamento participativo e muitas outras coisas semelhantes às que possuímos e praticamos. Não podemos confiar na técnica e na mera organização. Ela é apenas uma roupa que colocamos e que podemos trocar de acordo com a necessidade. Crianças trocam de roupas ao crescerem e, como elas, as igrejas mudam de estrutura e organização, à medida que crescem também. Se a comunhão que praticamos em nada difere da do Rotary ou do Lyons, o que estamos fazendo de mais? Se a nossa pregação não difere da oratória política ou das palestras acadêmicas, o que estamos ministrando de mais? A mensagem de Jesus foi muito clara: Ele não veio para revogar, veio para transcender. É aqui que reside a grande diferença: precisamos transcender às práticas comuns do mundo.Transcender não é apenas fazer melhor; é fazer sobrenaturalmente. Não podemos atrair o mundo apenas com nossas canções, pois as pessoas do mundo têm músicas até melhor produzidas que as nossas.Não podemos atrair o mundo apenas com teatro, dramas e encenações, pois lá eles as fazem muito melhor do que nós. Nem podemos atrai-los com grupos pequenos, pois isso eles também possuem.'

export const explicationCell2 = 'Entretanto, existe algo que nem eles e nem ninguém pode fazer: um boi cantar em cima do telhado. Isso somente a unção pode fazer. Sem o poder de Deus, entretemos os santos e nos iludimos com atividades. A Igreja não é terrena; a sua origem é celestial assim como o seu poder e a sua própria vida. Qualquer coisa que não for feita com base nesta força espiritual não traduzirá a realidade da Igreja; seja comunhão, pregação, aconselhamento, músicas ou as células. Precisamos da unção do Senhor, pois ela subverte a nossa ordem e os nossos conceitos. Ela transcende o padrão do nosso trabalho. Nossa comunhão não pode ser comum, natural, mas, sim, do tipo com o qual o próprio Deus subsiste. Nossa pregação não pode ser uma palestra inteligente e intrigante, mas, sim, a voz do próprio Deus trovejando dos céus sobre a Terra. Nossa autoridade não pode se prender aos nossos títulos acadêmicos, nem ao volume de voz que usamos nas pregações, e sim à autoridade do Espírito Santo. Não somos frutíferos porque temos técnicas, mas porque possuímos a unção. Não importa o quanto tentemos, só a unção poderá levar um boi a cantar como um pássaro em cima de um telhado. Se a nossa ministração nas células reproduzir as técnicas e dinâmicas aplicadas na psicologia de grupos, estaremos perdendo o nosso tempo. Não somos uma empresa, somos Igreja do Senhor Jesus. Aprenda a técnica e a metodologia de nossa visão, mas lembre-se de que mais importante que os odres é a fonte real do crescimento, da vida, dos frutos e de tudo o mais: o vinho novo do Espírito. Que o Senhor da glória, o Rei Jesus, derrame sobre você desta unção que faz o inusitado e frutifica além do esperado. Esta unção é que torna a vida mais que um evento e que faz dela uma expressão do celestial. Tudo começa com a oração A nossa oração é que, em algum momento, enquanto você estiver estudando este manual, você receba uma revelação especial de Deus. Que você veja a Igreja pelos olhos de Deus e seja conquistado por uma visão celestial: a edificação de uma igreja de vencedores. Deixe-se contagiar por estes dois sonhos: multiplicar as células (uma vez por ano) e conquistar a nossa geração para Cristo. Mas, antes de tudo, tire alguns minutos para escrever o que você está sentindo. Use as linhas abaixo para escrever uma oração a Deus.'

export const explicationCell3 = 'Uma Igreja de Vencedores Nosso encargo é edificar uma igreja de vencedores, na qual cada membro é um ministro e cada casa uma extensão da igreja, conquistando, assim, a nossa geração para Cristo, através de células que se multiplicam uma vez ao ano. Esse é o nosso slogan, a nossa declaração de propósito. A primeira parte dele diz que nosso encargo é edificar uma igreja de vencedores. O que é ser uma igreja de vencedores? É ser uma igreja que cumpre o propósito de Deus. E qual é esse propósito? Ter um grupo de pessoas à Sua imagem e semelhança. Deus deseja que o homem seja enchido com Ele mesmo como vida, a fim de expressá-Lo e que tenha o Seu domínio para representá-Lo na Terra. O homem foi criado como um vaso para conter Deus dentro de si. Fomos feitos como uma luva para conter a Deus. A luva é imagem e semelhança da mão, mas a mão é a realidade da luva. Uma luva é criada conforme a semelhança da mão com o propósito de contê-la. Igualmente, o homem foi criado à imagem de Deus com o propósito de conter a Divindade. Uma vez que o homem recebe a Pessoa de Deus como vida dentro de si mesmo, ele se torna um instrumento nas mãos de Deus. Para que o homem fosse usado como instrumento, Deus deu a ele a seguinte ordem: Sede fecundos, multiplicai-vos, enchei a terra e sujeitai-a; dominai sobre os peixes do mar, sobre as aves dos céus e sobre todo animal que rasteja pela terra. (Gn 1.28). Crescer e multiplicar A primeira ordem dada ao homem, na velha criação, foi para crescer e multiplicar-se. A mesma ordem nos é dada, hoje, na nova criação. Todos nós recebemos a ordem de crescer e multiplicar (Mt 28.20; Mc 16.15). A diferença é que Adão se multiplicava como alma vivente; hoje, porém, nós nos multiplicamos pelo espírito de vida (1Co 15). Uma igreja de vencedores, portanto, é aquela que cumpre o propósito original de Deus: crescimento e multiplicação. Não há como cumprir o propósito de Deus sem fecundidade e multiplicação; por isso, nossa visão exige a multiplicação de cada célula pelo menos uma vez por ano. Um líder vencedor é aquele que multiplica sua célula pelo menos uma vez por ano.'

export const explicationCell4 = 'Sujeitar e dominar Deus também disse para o homem dominar, ou seja, deu-lhe autoridade para exercer o domínio como se fosse o próprio Deus. Qualquer um que visse Adão saberia que ele representava Deus, pois, em tudo, era semelhante ao Criador. Conserve em sua mente estas duas palavras: imagem e domínio. Porque temos a imagem, exercemos o domínio. Imagem é para expressar (o próprio Deus) e domínio é para exercer autoridade (de Deus). Todos nós precisamos lidar com o inimigo sujeitando-o em todas as esferas de nossas vidas (Mt 16.19; Mt 18.18; Rm 16.20). Sujeitar o inimigo significa vencê-lo em todas as circunstâncias e não deixá-lo levar vantagem em nenhum momento. Quando sujeitamos e exercemos domínio, dizemos que estamos cumprindo a visão de que cada crente é um ministro. O ministro sujeita e domina através da oração e da autoridade no nome de Jesus. Assim, uma igreja de vencedores é aquela que cresce e se multiplica, mas que também exerce domínio, porque possui a imagem de Deus em seu caráter. Guarde o propósito duplo de Deus. Primeiro, Ele quer ter o homem à Sua imagem para exercer domínio, ou seja: ser um ministro. Em segundo lugar, Deus deseja que esse homem se multiplique. Uma igreja de vencedores tem a visão de conquistar a sua geração. Não apenas salvos, mas vencedores O entendimento comum no meio evangélico é de que todo crente é um vencedor. De fato, isso é parcialmente verdadeiro. Em todas estas coisas, porém, somos mais que vencedores, por meio daquele que nos amou. (Rm 8.37) Na verdade, todo crente é legalmente um vencedor, por causa da vitória de Cristo. Mas, experimentalmente, muitos vivem como derrotados. Os crentes vencedores cumprem o propósito de Deus, enquanto os crentes derrotados ignoram e desprezam o encargo de Deus para esta geração. Há uma diferença entre posição legal e posição experimental. Posição legal é aquilo que, por direito, é nosso. Legalmente, já somos mais que vencedores – Cristo já nos garantiu a vitória.'

export const explicationCell5 = ' Ele já pagou o preço da nossa Redenção, na cruz, e subjugou todos os principados e potestades. Ele venceu, e assim, porque estamos nEle, nós também somos vencedores. A posição dEle é a nossa posição também. Entretanto, posição experimental é algo bem diferente. Tomar algo experimentalmente significa experimentar algo que já é verdade legalmente. Há muitos crentes que legalmente são herdeiros de uma grande fortuna, mas, experimentalmente, vivem numa miséria absoluta. Sendo filhos do Rei, vivem como se fossem escravos. Em nossa igreja, adotamos este slogan: O nosso encargo é edificar uma igreja de vencedores. Vencedores são aqueles crentes que já experimentam, na prática, aquilo que lhes pertence legalmente. Uma coisa é ser salvo, outra coisa é ser vencedor. Apesar de todo crente nascido de novo ser um vencedor legalmente, sabemos que essa não é a experiência de todos. Na verdade, existem muitos crentes que são derrotados. Talvez, você não concorde com essa tese e me questione: Você está dizendo que um crente derrotado é salvo? Entenda isto: a condição para alguém obter a salvação é uma, enquanto a condição para o salvo tornar-se vencedor é outra. A salvação tem a ver com a vida eterna, que é um presente de Deus a todo aquele que crê; agora, tornar-se um vencedor é algo relacionado com o galardão e o reinado milenar com Cristo. A salvação é alcançada mediante a fé; a recompensa, pelas obras que praticarmos diante de Deus. A salvação – ter a vida eterna – é uma coisa; enquanto o reino – ser vencedor – é outra. A recompensa é apenas para os vencedores. Você pode ter a vida eterna, você pode ter salvação e ainda assim viver como um derrotado. Essa é uma questão muito séria. Poucos se importam com a questão da recompensa ou do galardão que receberemos diante de Deus. Ninguém se engane pensando que receberemos galardão porque aceitamos a Jesus. Galardão tem a ver com trabalho feito para Deus. A grande recompensa dos crentes será reinar com Cristo durante o milênio, depois que Ele voltar. Mas deixe-me dizer-lhe algo: se você não está disposto nem mesmo a liderar uma célula, como poderá reinar com Cristo? Se não existe o desejo, o encargo, de multiplicar a sua célula uma vez por ano, não haverá galardão algum. Numa igreja de vencedores, cada membro é um ministro e todos se dispõem a liderar uma célula multiplicando-a uma vez por ano. O sinal de que estamos atuando como uma igreja de vencedores é ver as células se multiplicarem.'

export const explicationCell6 = 'Nossa visão é um encargo em nosso coração. Há uma diferença entre cargo e encargo. Cargo é a posição que as pessoas assumem dentro de uma organização. Encargo é um desejo profundo no coração, compartilhado por aqueles que fazem parte de um mesmo organismo. O encargo procede de um desejo profundo no coração. Cargos são posições que geram status, encargos são sonhos do espírito. Quem trabalha por cargo precisa ser supervisionado o tempo todo, não tem motivação para criar nada e só faz o que mandam; quem tem encargo está disposto a dar a própria vida pelo objetivo proposto. Existem dois tipos de líderes que não queremos em nossa igreja: aqueles que não fazem o que se manda e aqueles que só fazem o que se manda¹. Os primeiros são ineficazes e os segundos possuem apenas o cargo, mas não o encargo. O líder que recebeu o encargo não apenas faz o que se manda, mas vai além: ele cria, ele sonha e realiza além do que foi pedido. São homens que estão dispostos a verter sangue, suor e lágrimas, como dizia Winston Churchil.O clericalismo Existe um grande impedimento à visão de que cada crente seja um ministro: o clericalismo. O clericalismo é o sistema que surgiu dentro da igreja depois do quarto século e que estabeleceu que na Igreja há dois tipos de pessoas: os clérigos e os leigos. As especialmente dotadas e capacitadas são chamadas clérigos (São os sacerdotes, os reverendos, os doutores em divindades etc.) A outra classe, a dos ignorantes e incapazes, é de leigos. O sistema de clérigos e leigos é totalmente maligno e uma grande ameaça, pois ele anula completamente o conceito básico do sacerdócio universal dos crentes, ou seja, a verdade de que cada crente é um ministro. Infelizmente, na maioria das igrejas, predomina o clericalismo, os membros não funcionam, tornaram-se letárgicos. O inimigo tem conseguido anestesiar os membros para que não funcionem. Em nossos dias, há dois tipos de clericalismo. No primeiro, os próprios clérigos se colocam acima dos leigos, afirmando que são eles os que sabem, os que conhecem e, portanto, são incontestáveis. Chegam mesmo a proibir os membros de pregar, ensinar ou fazer qualquer outra coisa. Nesse ambiente, a única função dos membros é ir à igreja e se assentarem nos bancos olhando para a frente a fim de ouvir o pregador. Certo artista plástico foi convidado a pintar um quadro que fosse o retrato da Igreja. Surpreendentemente, ele pintou um monte de nádegas com dois olhos enormes por cima '

export const explicationCell7 = 'Aquela tela, infelizmente, traduziu a realidade de muitas igrejas: um monte de nádegas com dois olhos esbugalhados. Os membros só sabem sentar-se e olhar para frente, nada mais. O segundo tipo de clericalismo é conseqüência do primeiro. Nele, o povo está tão acostumado à situação que contrata um pregador profissional – um funcionário do púlpito – e exige que ele faça a obra de Deus, enquanto os membros apenas dão o dinheiro. No primeiro caso, o clero proíbe o povo de falar; no segundo, o povo se cala, deliberadamente, e contrata um profissional para expressar-se em seu lugar. Cada crente é um ministro Na maioria das igrejas, hoje, não há nenhum senso de Corpo de Cristo, ou estrutura na qual os membros possam estar envolvidos de maneira funcional. Por causa disso, a maioria, por decisão pessoal, escolhe sentar-se nos bancos do prédio da igreja, disposta a não se envolver. Ao contrário dessa concepção, na visão de células, não há como se omitir ou não se envolver! Estar na visão é estar comprometido! Crentes que não se envolvem são crentes parasitas. Eles esperam ser mimados, ministrados e entretidos pela igreja. Em troca, são contabilizados na estatística e, eventualmente, dão uma oferta – ou algo parecido – para manter “o Sistema”. Esse tipo de crente faz parte dos 85% dos membros que são carregados e ministrados pelos outros 15%. Não há, na igreja convencional, nenhum contexto no qual o crente possa ser treinado a produzir, ao invés de consumir. Já na igreja em células, seus membros têm oportunidade de desenvolver seus potenciais e se tornarem produtivos. Lamentavelmente, essa dinâmica não está sendo experimentada na maioria das igrejas cristãs hoje. Muitos de seus membros freqüentam, fortuitamente, apenas as reuniões dominicais e não se dispõem a envolver-se nos programas de atividades de suas igrejas. Conseqüentemente, transformam-se apenas em mais um dado estatístico do Relatório Anual de Atividades da Igreja “X”, no qual figuram no gráfico dos “esquentadores de bancos”, ou no dos “contribuintes do Sistema”, ou no dos “expectadores sem importância”.  O sistema de Jesus foi projetado para resultar em produtores, e não em consumidores, ou parasitas. Precisamos retomar, nesses dias, ao fundamento do sacerdócio universal do crente, a verdade de que cada um de nós é um ministro. (IPe 2.9) Não existe em nossa igreja um departamento ou um programa de células. O nosso alvo é bem mais ambicioso.'

export const explicationCell8 = ' Nós queremos restaurar o modelo de Igreja do Novo Testamento, com um novo tipo de membro. Isso, na verdade, representa o restabelecimento do paradigma original da igreja, no qual o membro não é mais um mero consumidor espiritual (no shopping da igreja), mas um produtor útil e frutífero na família de Deus. Muitos encaram a igreja como uma prestadora de serviços espirituais, na qual podem buscar, quando desejarem, uma ministração forte, uma palavra interessante, uma aula apropriada para seus filhos, um ambiente agradável, e assim por diante. Quando, por algum motivo, os serviços da igreja caem de qualidade, esses consumidores saem à procura de outro shopping espiritual mais eficiente. Membros assim não têm aliança com o Corpo. Jesus nos chamou para fazer discípulos e não apenas convertidos!³ Por isso queremos ser um povo com uma vida cristã sólida, com a prática regular de oração e leitura da Palavra de Deus. Queremos ser um povo cujos lares são aquecidos pelo amor! Queremos ser uma comunidade que serve a Deus, com os dons, na família, na escola, no trabalho, na igreja etc. Em outras palavras, nós desejamos ser ministros. Como é o crente que se torna um ministro? Existe uma diferença entre ter a visão e a visão ter você. Ter uma visão não é algo difícil. Basta mudar nossa terminologia. Todavia, ser conquistado por uma visão é completamente diferente, pois implica numa mudança de mentalidade. Quando um crente compreende que ele deve produzir, e não simplesmente consumir, uma verdadeira revolução acontece na sua postura em relação à igreja local. Ele não se preocupa em saber o que a igreja pode lhe oferecer; antes, preocupa-se em saber como ele pode ser útil a ela.  Ele não responsabiliza o pastor ou algum líder pelo seu crescimento espiritual, porque sabe que pode e deve ter intimidade com Deus sem intermediário algum. Ele encara suas próprias guerras e ainda tem disposição para dar apoio e socorro aos novos convertidos nas guerras deles.  Se tiver que se mudar para outra cidade, ele sabe que a igreja vai junto com ele. Ele sabe que mesmo distante do prédio, a igreja acontece onde ele estiver. Alguém conquistado pela visão está consciente de seus dons e de que deve usá-los para a edificação dos outros membros.'

export const explicationCell9 = 'Esta visão, apesar de ser revolucionária, não é nova. Desde os tempos da Reforma Protestante já se falava em sacerdócio universal dos crentes. Estamos apenas retornando às origens e procurando viver segundo o padrão de Deus. Cada Casa Uma Extensão da Igreja É algo realmente gratificante ver tantas pessoas funcionando como membros do corpo vivo de Cristo. Temos o privilégio de ver uma estrutura funcionando com liberdade, sem temores e permitindo o desenvolvimento do pleno potencial de cada um. Em nossa igreja já não temos que convencer as pessoas a respeito de células, nós apenas as vivemos em nosso dia-a-dia. Ainda temos sacerdotes profissionais (nada é perfeito!), mas cada crente tem funcionado como um sacerdote, um ministro. Vejamos agora o terceiro aspecto de nossa visão: cada casa é uma extensão da igreja. O prédio onde nos reunimos não é o retrato de nossa igreja. Ela poderia ser vista melhor como um tabernáculo no deserto, perambulando de um lugar a outro, acontecendo simultaneamente por toda a cidade, nas casas. Nas células, existe uma mobilização natural para ajudar os necessitados. Os mais velhos ensinam aos mais novos o que é ser crente. Os pastores treinam os novos líderes para o desempenho do serviço e todo o corpo se mobiliza para a festa da colheita de almas; afinal, cada célula visa se reproduzir e se multiplicar uma vez por ano. Falamos todos uma mesma linguagem e há uma unanimidade santa de propósito entre nós. Em nosso coração sentimos que estamos voltando para os primórdios da Igreja do primeiro século. Nós somos uma igreja em células Cada instituição é a cara do prédio onde se reune, mas a nossa igreja não existe em função do prédio onde nos reunimos. O prédio para nós é apenas um lugar de treinamento e celebração, a vida normal da igreja acontece em outros lugares, no nosso dia-a-dia. Apesar de, no Velho Testamento, Deus ter habitado num templo, isso já não acontece no Novo Testamento. Hoje, nós somos o templo de Deus: Ele habita em nós. Assim, biblicamente falando, a Igreja do Novo Testamento possui um lugar de reunião, mas não possui templos. Os templos são uma grande contradição do cristianismo. Na verdade, eles não existiam até o segundo século. Se você procurasse pela igreja no primeiro século você seria conduzido a um grupo de pessoas se reunindo numa casa.'
